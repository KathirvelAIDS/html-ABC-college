...
<body>
    <header>
        <div class="container">
            <img src="C:\Users\nihil\Pictures\Hindustan_Institute_of_Technology_and_Science_logo.png" alt="College Logo">
            <nav>
                <ul>
    ...
    <div class="container">
        <section>
            <h2>Academics</h2>
            <p>The Hindustan Engineering College has an excellent academic coordination methodology which has evolved over a period of more than 17 years and 
...
<body>
    <header>
        <div class="container">
            <img src="C:\Users\nihil\Pictures\Hindustan_Institute_of_Technology_and_Science_logo.png" alt="College Logo">
            <h1>Hindustan Engineering College</h1>
            <nav>
                <ul>
                    <li><a href="index.html">Home</a></li>
                    <li><a href="academics.html">Academics</a></li>
        ...
        <section>
            ...
            <form action="#" method="post">
                ...
                <select id="course" name="course" required>
                    ...
                    <option value="Sociology">AI-DS</option>
...
<body>
    ...
    <div class="container">
        <section>
            <h2>Gallery</h2>
            <div class="gallery">
                <img src="C:\Users\nihil\Pictures\images.jpeg" alt="Gallery Image 1">
                <img src="C:\Users\nihil\Pictures\1616739954phpEG9PVU.jpeg" alt="Gallery Image 2">
                <img src="C:\Users\nihil\Pictures\hiet-banner-1.jpg" alt="Gallery Image 3">
...
<tr align="center">
   ...
   <td bgcolor="Orange"><b> Fundamentals Of Web Development Application</b></td>
   <td> Free Slot </td>
   <td bgcolor="green"><b>Problem sloving And Python Programming</b></td>
   <td> Free Slot </td>
   <td> Free Slot </td>
   <td> Free Slot </td>
</tr>
...
```
# Output:
![image](https://github.com/KathirvelAIDS/html-ABC-college/assets/94911373/9a81213f-da49-4120-80b8-3001cccc571e)
